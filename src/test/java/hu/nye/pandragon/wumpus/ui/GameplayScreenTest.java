...
class GameplayScreenTest {
	...
	public void shouldThrowExceptionOnheroNotFound () {
		...
		Assertions.assertThrows(RuntimeException.class, () -> new GameplayScreen(levelVO, new PlayernameVO("Doragon ga suki desu")));
	}

	@Test
	public void shouldExitOnWhenHeroIsNotAlive () {
		level.getHero().setAlive(false);
		gameplayScreen = new GameplayScreen(level.toLevelVO(), new PlayernameVO("Doggo ga arimasu ka"));
